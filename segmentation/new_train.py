...
if __name__ == "__main__":
    ...
    callbacks = [
    ModelCheckpoint(filepath_save_checkpoint, monitor='val_loss', verbose=1, save_best_only=True, mode='min'),
    ...
    # to training, comment if you want to predict
    model.fit(
        train_dataset,
    ...
    model.save("res/result_checkpoint.hdf5")
